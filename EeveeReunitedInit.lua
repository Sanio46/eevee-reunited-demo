...
function EeveeReunited:init(j)
	...
	EeveeReunited:AddCallback(ModCallbacks.MC_FAMILIAR_INIT, EeveeReunited.CreatePersistentLilEeveeData,
...
function EeveeReunited:LoadEeveeData()
	if EeveeReunited:HasData() then
		...
		if not newData.SaveDataVer or newData.SaveDataVer ~= SaveDataVer then
			...
			EEVEEMOD.PERSISTENT_DATA.UnlockData.Eevee = EeveeReunited.SavedData.UnlockData_Eevee or
				EEVEEMOD.PERSISTENT_DATA.UnlockData.Eevee
			EEVEEMOD.PERSISTENT_DATA.UnlockData.Eevee_B = EeveeReunited.SavedData.UnlockData_Eevee_B or
				EEVEEMOD.PERSISTENT_DATA.UnlockData.Eevee_B
			EEVEEMOD.PERSISTENT_DATA.UnlockData.PokeyMansCrystal = EeveeReunited.SavedData.UnlockData_PokeyMansCrystal or
				EEVEEMOD.PERSISTENT_DATA.UnlockData.PokeyMansCrystal
		end
	end
end
...
function EeveeReunited:postFireTear(tear)
	local evileyes = Isaac.FindByType(EntityType.ENTITY_EFFECT, EffectVariant.EVIL_EYE)
	local increase = 1 / (#evileyes + 1)
	tearsFired = tearsFired + increase
end
...
EeveeReunited:AddCallback(ModCallbacks.MC_POST_EFFECT_INIT, EeveeReunited.postEntCheckInit, EffectVariant.EVIL_EYE) --Change this to whatever you're checking ]]
