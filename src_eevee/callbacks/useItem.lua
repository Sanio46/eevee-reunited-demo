...
function useItem:init(EeveeReunited)
	...
	--EeveeReunited:AddCallback(ModCallbacks.MC_USE_ITEM, dive.OnUse, EEVEEMOD.CollectibleType.DIVE)
	...
	--EeveeReunited:AddCallback(ModCallbacks.MC_USE_ITEM, leafBlade.OnUse, EEVEEMOD.CollectibleType.LEAF_BLADE)
