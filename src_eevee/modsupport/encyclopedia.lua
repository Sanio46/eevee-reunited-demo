	...
	local CharactersWiki = {
		PlayerEevee = {
			...
			{ --Traits
				...
				{str = "The closest enemy within a 45 degree angle of the direction the stars will fire, and within a radius scaled with your range, once fired, will fire directly towards that enemy."},
