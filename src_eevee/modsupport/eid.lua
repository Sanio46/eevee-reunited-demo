...
local CollectibleDescs_EN = {
	[EEVEEMOD.CollectibleType.SNEAK_SCARF] = { "Sneak Scarf",
	...
	[EEVEEMOD.CollectibleType.SHINY_CHARM] = { "Shiny Charm",
	...
	[EEVEEMOD.CollectibleType.BLACK_GLASSES] = { "Black Glasses",
	...
	[EEVEEMOD.CollectibleType.COOKIE_JAR] = { "Cookie Jar",
	...
	[EEVEEMOD.CollectibleType.LIL_EEVEE] = { "Lil Eevee",
	...
	[EEVEEMOD.CollectibleType.BAD_EGG] = { "Bad EGG",
		"Blocks projectiles, up to 32 before breaking#{{Warning}} Upon breaking, replaces a random owned famliiar with a duplicate {{Collectible"
			...
			.. EEVEEMOD.CollectibleType.STRANGE_EGG .. "}} Strange Egg" },
	[EEVEEMOD.CollectibleType.BAD_EGG_DUPE] = { "Duped Bad EGG",
	...
	[EEVEEMOD.CollectibleType.WONDEROUS_LAUNCHER] = { "Wonderous Launcher",
	...
	[EEVEEMOD.CollectibleType.BAG_OF_POKEBALLS] = { "Bag of Poké Balls",
		"Every 12 rooms, spawns a random type of Poké Ball#50% {{Card" ..
			EEVEEMOD.PokeballType.POKEBALL ..
			"}} Poké Ball#30% {{Card" ..
			EEVEEMOD.PokeballType.GREATBALL .. "}} Great Ball#20% {{Card" .. EEVEEMOD.PokeballType.ULTRABALL .. "}} Ultra Ball" },
	[EEVEEMOD.CollectibleType.MASTER_BALL] = { "Master Ball - {{Throwable}}",
	...
	[EEVEEMOD.CollectibleType.POKE_STOP] = { "Poke Stop",
	...
	[EEVEEMOD.CollectibleType.TAIL_WHIP] = { "Tail Whip",
...
local TrinketDescs_EN = {
	[EEVEEMOD.TrinketType.EVIOLITE] = { "Eviolite",
	...
	[EEVEEMOD.TrinketType.LOCKON_SPECS] = { "Lock-On Specs",
	...
	[EEVEEMOD.TrinketType.ALERT_SPECS] = { "Alert Specs",
...
local CardDescs_EN = {
	...
	[EEVEEMOD.PokeballType.GREATBALL] = { "Great Ball - {{Throwable}}",
		"Throw at enemies and bosses to capture them#Captured enemies become permanently charmed#Ball may break after capture#On bosses, may resist capture depending on HP and status effects, will always break regardless of capture#{{Card"
			.. EEVEEMOD.PokeballType.GREATBALL .. "}} x2 Capture Rate, moderate effect on health" },
	[EEVEEMOD.PokeballType.ULTRABALL] = { "Ultra Ball - {{Throwable}}",
		"Throw at enemies and bosses to capture them#Captured enemies become permanently charmed#Ball may break after capture#On bosses, may resist capture depending on HP and status effects, will always break regardless of capture#{{Card"
...
local CollectibleDescs_SPA = {
	[EEVEEMOD.CollectibleType.SNEAK_SCARF] = { "Bufanda de escape",
	...
	[EEVEEMOD.CollectibleType.SHINY_CHARM] = { "Amuleto Iris",
	...
	[EEVEEMOD.CollectibleType.BLACK_GLASSES] = { "Lentes oscuros",
	...
	[EEVEEMOD.CollectibleType.COOKIE_JAR] = { "Tarro de galletas",
	...
	[EEVEEMOD.CollectibleType.BAD_EGG] = { "Huevo malo",
	...
	[EEVEEMOD.CollectibleType.BAD_EGG_DUPE] = { "Huevo malo duplicado",
	...
	[EEVEEMOD.CollectibleType.STRANGE_EGG] = { "Strange Egg",
		"Recibe +1 carga por piso#Puede ser usado sin estar completamente cargado, con distintos efectos en base a sus cargas:#{{Battery}} {{ColorYellow}}1{{ColorWhite}}: {{Heart}} Cura 3 corazones rojos#{{Battery}} {{ColorYellow}}2{{ColorWhite}}: Genera {{Collectible"
			...
			EEVEEMOD.CollectibleType.LIL_EEVEE .. "}} Lil Eevee and 2 {{Heart}} Red Hearts" },
	[EEVEEMOD.CollectibleType.LIL_EEVEE] = { "Pequeño Eevee",
	...
	[EEVEEMOD.CollectibleType.WONDEROUS_LAUNCHER] = { "Lanzador",
	...
	[EEVEEMOD.CollectibleType.BAG_OF_POKEBALLS] = { "Bolsa de Pokébolas",
	...
	[EEVEEMOD.CollectibleType.POKE_STOP] = { "Poképarada",
	...
	[EEVEEMOD.CollectibleType.TAIL_WHIP] = { "Látigo",
...
local TrinketDescs_SPA = {
	[EEVEEMOD.TrinketType.EVIOLITE] = { "Mineral Evolutivo",
...
local CollectibleDescs_KR = {
	...
	[EEVEEMOD.CollectibleType.BAG_OF_POKEBALLS] = { "몬스터볼 가방",
		"!!! 방 12개 클리어 시 랜덤 몬스터볼을 드랍합니다:#{{Card" ..
			EEVEEMOD.PokeballType.POKEBALL ..
			"}} 몬스터볼: 50%#{{Card" ..
			EEVEEMOD.PokeballType.GREATBALL .. "}} 슈퍼볼: 30% #{{Card" .. EEVEEMOD.PokeballType.ULTRABALL .. "}} 하이퍼볼: 20%" },
	[EEVEEMOD.CollectibleType.MASTER_BALL] = { "마스터볼",
...
local CardDescs_KR = {
	[EEVEEMOD.PokeballType.POKEBALL] = { "몬스터볼",
